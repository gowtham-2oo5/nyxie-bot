  ...
  },
  {
    ...
    operations: [
      ...
      },
      {
        ...
        guide: [
          "**`/admin cooldown list [@player]`** — View active cooldowns.",
          "**`/admin cooldown cancel <@player>`** — Cancel a player's cooldown (including unavoidable).",
          "",
          "Use when a player's cooldown should be lifted early.",
          "",
          "**Prefix:** `!admin cd cancel/list @player`",
        ].join("\n"),
      },
    ],
  },
    ...
    operations: [
      ...
      },
      {
        ...
        guide: [
          ...
          "**Admin cancel:** `/admin cooldown cancel <@player>`",
          "**View active CDs:** `/admin cooldown list [@player]`",
          "",
